        ...
        <div className="container mx-auto px-6 sm:px-10 max-w-7xl">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-6xl font-semibold leading-tight tracking-tight">
              Advanced Wellness Intelligence for Modern Care
            </h1>
            <p className="mt-4 text-lg text-white/80">
              A 3D, AI-native experience for preventive health. Built for clinical credibility, enterprise security, and delightful UX.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <a href="#ai-search" className="inline-flex items-center justify-center rounded-md border border-white/20 hover:bg-white/5 transition px-6 py-3">
